  ...
  return (
    <>
      ...
      <nav style={{
        ...
        zIndex: 1000,
        width: "calc(100% - 32px)", maxWidth: 1000,
        padding: "14px 24px",
        display: "flex", justifyContent: "space-between", alignItems: "center",
        background: scrolled ? "rgba(10,10,10,0.92)" : "rgba(255,255,255,0.05)",
        ...
        <span style={{
          ...
          fontWeight: 400, color: "rgba(255,255,255,0.95)", letterSpacing: 1,
          flexShrink: 0,
        }}>
          M. Musharraf
        </span>
        ...
        <ul className="nav-links-list" style={{
          gap: 4, listStyle: "none", margin: 0, padding: 0, alignItems: "center",
        }}>
          {navItems.map((item) => (
            <li key={item}>
              <button onClick={() => handleNav(item)} style={{
                ...
                fontSize: 13, letterSpacing: 0.3, fontFamily: "'Georgia', serif",
        ...
        <button className="nav-burger" onClick={() => setOpen(v => !v)} style={{
          ...
          {[0, 1, 2].map(i => (
            <span key={i} style={{
              display: "block", width: 16, height: "1px",
              background: open && i === 1 ? "transparent" : "rgba(255,255,255,0.75)",
              transform: open
